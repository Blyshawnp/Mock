...
public partial class SupervisorTransferOnlyDialogViewModel : ViewModelBase
{
    public SupervisorTransferOnlyDialogViewModel()
    {
        Candidates =
        [
            new CandidateRow("John Doe", "Shawn Bly"),
            new CandidateRow("Jane Smith", "Alex Carter"),
            new CandidateRow("Michael Brown", "Shawn Bly"),
            new CandidateRow("Emily Davis", "Test Tester"),
            new CandidateRow("Robert Wilson", "Shawn Bly"),
            new CandidateRow("Lisa Taylor", "Alex Carter"),
            new CandidateRow("David Moore", "Shawn Bly"),
            new CandidateRow("Sarah Anderson", "Test Tester"),
            new CandidateRow("James Thomas", "Alex Carter"),
            new CandidateRow("Karen Jackson", "Shawn Bly")
        ];
